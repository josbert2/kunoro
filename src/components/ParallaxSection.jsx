...
const ParallaxSection = () => {
  ...
  const backgroundTransform = `translate3d(0, ${scrollY * -100}px, 0) scale(${1 + scrollY * 0.1})`;
  const contentTransform = `translate3d(0, ${scrollY * 50}px, 0)`;
  const decorativeTransform1 = `translate3d(0, ${scrollY * -80}px, 0) rotate(${scrollY * 10}deg)`;
  const decorativeTransform2 = `translate3d(0, ${scrollY * -60}px, 0) rotate(${scrollY * -15}deg)`;
    ...
    <section ref={sectionRef} className="relative overflow-hidden">
      ...
      >
        <div className="text-white text-xl font-bold relative text-center pt-20 pb-20 flex items-center justify-center">
          ...
          <div 
            className="absolute left-40 top-20 will-change-transform"
            style={{
              transform: decorativeTransform1,
            }}
          >
          ...
          <div 
            className="absolute right-40 top-40 will-change-transform"
            style={{
              transform: decorativeTransform2,
            }}
          >
        ...
        {/* Parallax Button */}
        <div 
          className="pb-32 pt-20 will-change-transform"
          style={{
            transform: `translate3d(0, ${scrollY * 20}px, 0)`,
          }}
        >
